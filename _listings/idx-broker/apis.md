...
created: "2018-08-25"
modified: "2018-08-25"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/apis.md
...
- name: IDX API 1.4.0 Test Runner - Get Mls List Components
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/mlslistcomponents-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/mlslistcomponents-get-openapi.md
- name: IDX API 1.4.0 Test Runner - Get Leads List Components
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/leadslistcomponents-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/leadslistcomponents-get-openapi.md
- name: IDX API 1.4.0 Test Runner - Get Partners List Components
  ...
  properties:
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/partnerslistcomponents-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/components/master/_listings/idx-broker/partnerslistcomponents-get-openapi.md
x-common:
- type: x-blog
